/* Ex001 - TRABALHANDO COM CLASSES
Crie uma classe chamada Pessoa que tenha os atributos nome e numero.
A classe deve ter um construtor que recebe o nome como parâmetro e inicializa o atributo numero com 0.
A classe deve ter um método protegido chamado info que exibe o nome e o número da pessoa.
Fique a vontade para criar outros métodos e atributos que achar necessário. */
  ...
  private concederCNPJ(): string {
    if (this.registrada) {
      ...
      let cnpjFormatado: string =
        ...
        '.' +
        numCNPJ6DigitosPosteriores.substring(2, 5) +
        '.' +
        numCNPJ6DigitosPosteriores.substring(5, 8) +
        '/' +
